...
var resizePizzas = function(size) {
  ...
  function changeSliderLabel(size) {
    switch(size) {
      case "1":
        document.getElementById("pizzaSize").innerHTML = "Small"; //Added getElementById to make the Web API call faster.
        return;
      case "2":
  ...
  function determineDx (elem, size) {
    ...
    var windowWidth = document.getElementById("randomPizzas").offsetWidth; //Added getElementById to make the Web API call faster.
  ...
  function changePizzaSizes(size){
    var randomPizzas = document.getElementsByClassName("randomPizzaContainer"); //Added getElementById to make the Web API call faster.
...
var pizzasDiv = document.getElementById("randomPizzas"); //pizzasDev is called outside the loop, so DOM call it only made once.
for (var i = 2; i < 100; i++) {
...
function updatePositions() {
  ...
  var items = document.getElementsByClassName('mover'); //Added getElementById to make the Web API call faster.
